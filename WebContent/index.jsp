 ...
 %>
		...
		<%
			...
			if (user == null) {
				...
				goumai = "/MyFristWeb/pages/userLogin.jsp";
			} else {
				s = user.getName();
				userpath = "/MyFristWeb/pages/loginSuccess.jsp";
				goumai = "/MyFristWeb/pages/loginSuccess.jsp";
			}
		%>
	...
	<div class="index-top-search">
		...
		<div class="index-cart">
			<a href="/MyFristWeb/pages/adminhome.jsp"><img alt="购物车"
				src="/MyFristWeb/images/43.png" border="0" width="100px"
				height="100px"></a>
		</div>
		...
		align="center"> -->
			...
			<c:forEach items="${sessionScope.goodInfoList}" var="good">
				<div class="goods_info_item">
					...
					<form action="/MyFristWeb/goodAndshoping.do?goodid=${good.id}" method="post">

						<a href="/MyFristWeb/goodinfo.do?goodid=${good.id}"> <img
							alt="${good.gname.trim()}" src="${good.image1}"></a> <a
							href="/MyFristWeb/goodinfo.do?goodid=${good.id}"><c:out
								value="${good.gname.trim()}"></c:out></a> <span
							id="goods_info_item_price"><c:out value="${good.gprice}"></c:out></span>
						<br /> <input type="submit" value="直接购买">
					</form>
